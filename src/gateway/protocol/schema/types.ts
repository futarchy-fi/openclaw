...
export type AuthSyncPushParams = SchemaType<"AuthSyncPushParams">;
export type AuthSyncPushRejectedResult = SchemaType<"AuthSyncPushRejectedResult">;
export type AuthSyncPushResult = SchemaType<"AuthSyncPushResult">;
